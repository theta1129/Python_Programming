# 파이썬의 자료형
# 1. 기본 자료형: 숫자형(정수형, 실수형, 복소수형), 불리언, 문자열
...
print(f"{0.1:.20f}")
print(f"{(0.1+0.1e-20):.20f}")
print(f"{0.2:.20f}")
print(f"{0.3:.20f}")


print(0.1 == (0.1+0.1e-200)) # 이건 왜 됨? -> 특정 구간은 같은 값으로 침!
...
# 숫자형 - 복소수형 (complex)
a = 10 + 1j
print(a, type(a)) # (10+1j) <class 'complex'>
print(a.real) # 실수부; 10.0
print(a.imag) # 허수부; 1.0