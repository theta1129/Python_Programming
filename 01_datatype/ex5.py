...
print(s.find("Python sucks. I hate Python."))               # 인덱스 반환 ( 없으면 -1 )
# print(s.index("Python sucks. I hate Python."))            # 인덱스 반환 ( 없으면 ValueError )
...
# 문제) replace는 원본 문자열을 바꿀까요? 새로운 문자열을 만들까요? -> 새로운 문자열 만듦!
print(s.replace("Python", "Unity"))     # 전체 치환
print(s.replace("Python", "Unity", 1))  # 1개만 치환

# 판별 문자열 메소드 (isXXX())
print("123".isdigit())              # 숫자이면 True; isnumeric은 한자 등도 된다고 함
